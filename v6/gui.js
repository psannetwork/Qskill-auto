(function(){
  ...
  // Header section with title and contact
  const header = document.createElement("div");
  header.style.cssText = "text-align:center;margin-bottom:20px";
  const title = document.createElement("h2");
  title.textContent = "Qskill Controll Panel";
  ...
  markLabel.style.cssText = "display:block;margin-bottom:5px;color:#e0e0e0";
  ...
  autoScoreLabel.style.cssText = "display:block;margin-bottom:5px;color:#e0e0e0";
  ...
  submitBtn.style.cssText = "padding:10px 20px;font-size:16px;cursor:pointer;background:#333;color:#e0e0e0;border:none";
  ...
  form.onsubmit = async e => {
    ...
    if(markAll==="n"){ 
      ...
      if(ln < 1 || ln > 16){ alert("レッスン番号は1～16"); return; }
    }
